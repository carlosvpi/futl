// Performs groupBy, accepting a label, a function, or a list of laberls or functions, to keyize the result

var type = require('../../util/type'),
    arrayConstructor = type.arrayConstructor,
    functionConstructor = type.functionConstructor;

function _groupBy(p, lst) {
    ...
    if (p.constructor !== arrayConstructor) {
        ...
        for (; i < le; i++) {
            ...
            rinstance[key] = rinstance[key] || [];
            rinstance[key].push(pe);
        }
    }
    return r;
}

module.exports = require('../../util/curry2').bind(this, _groupBy);
